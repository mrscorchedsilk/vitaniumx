      ...
      <div className="container-wide">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ScrollReveal delay={100}>
              <div className="bg-gradient-to-b from-white to-green-50 p-6 rounded-lg shadow-subtle border border-neutral-100 h-full">
            ...
            <ScrollReveal delay={200}>
              <div className="bg-gradient-to-b from-white to-blue-50 p-6 rounded-lg shadow-subtle border border-neutral-100 h-full">
                <div className="flex flex-col items-center mb-6">
                  <div className="mb-4 h-24 w-24 flex items-center justify-center">
                    <FloatingCertificationLogo
            ...
            <ScrollReveal delay={300}>
              <div className="bg-gradient-to-b from-white to-amber-50 p-6 rounded-lg shadow-subtle border border-neutral-100 h-full">
                <div className="flex flex-col items-center mb-6">
                  <div className="mb-4 h-24 w-24 flex items-center justify-center">
                    <FloatingCertificationLogo
            ...
            <ScrollReveal delay={400}>
              <div className="bg-gradient-to-b from-white to-orange-50 p-6 rounded-lg shadow-subtle border border-neutral-100 h-full">
                <div className="flex flex-col items-center mb-6">
                  <div className="mb-4 h-24 w-24 flex items-center justify-center">
                    <FloatingCertificationLogo
            ...
            <ScrollReveal delay={500}>
              <div className="bg-gradient-to-b from-white to-purple-50 p-6 rounded-lg shadow-subtle border border-neutral-100 h-full">
                <div className="flex flex-col items-center mb-6">
                  <div className="mb-4 h-24 w-24 flex items-center justify-center">
                    <FloatingCertificationLogo
