  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'glow-coral': '0 0 25px rgba(250, 82, 82, 0.25)',
      },
      backgroundImage: {
        'hero-pattern': 'linear-gradient(to right bottom, rgba(236, 253, 245, 0.9), rgba(240, 249, 255, 0.9)), url("/lovable-uploads/14814d51-64b7-4490-99b5-8d498ec273e7.png")',
